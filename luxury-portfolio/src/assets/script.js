...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            // Send form using EmailJS - Service ID: service_0z3q0k7, Template ID: template_08nqwhi
            emailjs.sendForm('service_0z3q0k7', 'template_08nqwhi', e.target, 'fY0zN0iG5vQ2rP8s')
                .then((result) => {
                    alert('Pesan berhasil dikirim ke hdcgaming21@gmail.com!');
                    e.target.reset();
                }, (error) => {
                    console.error('EmailJS error:', error);
                    alert('Gagal mengirim pesan. Silakan coba lagi atau hubungi langsung.');
                });
        });
    }
});
